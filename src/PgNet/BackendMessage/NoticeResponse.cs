...
namespace PgNet
{
    internal readonly struct NoticeResponse
    {
        ...
        public NoticeResponse(ReadOnlyMemory<byte> bytes)
        {
    ...
    internal readonly struct NoticeResponseField
    {
        public readonly byte Type;
        public readonly string Value;

        public NoticeResponseField(ref SequenceReader<byte> reader, Encoding encoding)
        {
