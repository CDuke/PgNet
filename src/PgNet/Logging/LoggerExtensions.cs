...
namespace PgNet.Logging
{
    ...
    {
        private static readonly Func<FormattedLogValues, Exception, string> s_messageFormatter = MessageFormatter;
        ...
        public static void Log(this ILogger logger, LogLevel logLevel, EventId eventId, Exception? exception, string message, params object[] args)
        {
            ...
            logger.Log(logLevel, eventId, new FormattedLogValues(message, args), exception, s_messageFormatter);
        }
