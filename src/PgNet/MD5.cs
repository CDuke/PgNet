...
namespace PgNet
{
    internal sealed class MD5
    {
        ...
        private static void Transform(ref Span<uint> state, ReadOnlySpan<byte> data)
        {
            ...
            c = FF(c, d, a, b, temp[2], MD5_S13, 0x242070db);
            b = FF(b, c, d, a, temp[3], MD5_S14, 0xc1bdceee);
            a = FF(a, b, c, d, temp[4], MD5_S11, 0xf57c0faf);
            d = FF(d, a, b, c, temp[5], MD5_S12, 0x4787c62a);
            c = FF(c, d, a, b, temp[6], MD5_S13, 0xa8304613);
            b = FF(b, c, d, a, temp[7], MD5_S14, 0xfd469501);
            a = FF(a, b, c, d, temp[8], MD5_S11, 0x698098d8);
            d = FF(d, a, b, c, temp[9], MD5_S12, 0x8b44f7af);
            c = FF(c, d, a, b, temp[10], MD5_S13, 0xffff5bb1);
            b = FF(b, c, d, a, temp[11], MD5_S14, 0x895cd7be);
            a = FF(a, b, c, d, temp[12], MD5_S11, 0x6b901122);
            d = FF(d, a, b, c, temp[13], MD5_S12, 0xfd987193);
            c = FF(c, d, a, b, temp[14], MD5_S13, 0xa679438e);
            b = FF(b, c, d, a, temp[15], MD5_S14, 0x49b40821);

            // Round 2
            a = GG(a, b, c, d, temp[1], MD5_S21, 0xf61e2562);
            d = GG(d, a, b, c, temp[6], MD5_S22, 0xc040b340);
            c = GG(c, d, a, b, temp[11], MD5_S23, 0x265e5a51);
            b = GG(b, c, d, a, temp[0], MD5_S24, 0xe9b6c7aa);
            a = GG(a, b, c, d, temp[5], MD5_S21, 0xd62f105d);
            d = GG(d, a, b, c, temp[10], MD5_S22, 0x02441453);
            c = GG(c, d, a, b, temp[15], MD5_S23, 0xd8a1e681);
            b = GG(b, c, d, a, temp[4], MD5_S24, 0xe7d3fbc8);
            a = GG(a, b, c, d, temp[9], MD5_S21, 0x21e1cde6);
            d = GG(d, a, b, c, temp[14], MD5_S22, 0xc33707d6);
            c = GG(c, d, a, b, temp[3], MD5_S23, 0xf4d50d87);
            b = GG(b, c, d, a, temp[8], MD5_S24, 0x455a14ed);
            a = GG(a, b, c, d, temp[13], MD5_S21, 0xa9e3e905);
            d = GG(d, a, b, c, temp[2], MD5_S22, 0xfcefa3f8);
            c = GG(c, d, a, b, temp[7], MD5_S23, 0x676f02d9);
            b = GG(b, c, d, a, temp[12], MD5_S24, 0x8d2a4c8a);

            // Round 3
            a = HH(a, b, c, d, temp[5], MD5_S31, 0xfffa3942);
            d = HH(d, a, b, c, temp[8], MD5_S32, 0x8771f681);
            c = HH(c, d, a, b, temp[11], MD5_S33, 0x6d9d6122);
            b = HH(b, c, d, a, temp[14], MD5_S34, 0xfde5380c);
            a = HH(a, b, c, d, temp[1], MD5_S31, 0xa4beea44);
            d = HH(d, a, b, c, temp[4], MD5_S32, 0x4bdecfa9);
            c = HH(c, d, a, b, temp[7], MD5_S33, 0xf6bb4b60);
            b = HH(b, c, d, a, temp[10], MD5_S34, 0xbebfbc70);
            a = HH(a, b, c, d, temp[13], MD5_S31, 0x289b7ec6);
            d = HH(d, a, b, c, temp[0], MD5_S32, 0xeaa127fa);
            c = HH(c, d, a, b, temp[3], MD5_S33, 0xd4ef3085);
            b = HH(b, c, d, a, temp[6], MD5_S34, 0x04881d05);
            a = HH(a, b, c, d, temp[9], MD5_S31, 0xd9d4d039);
            d = HH(d, a, b, c, temp[12], MD5_S32, 0xe6db99e5);
            c = HH(c, d, a, b, temp[15], MD5_S33, 0x1fa27cf8);
            b = HH(b, c, d, a, temp[2], MD5_S34, 0xc4ac5665);

            // Round 4
            a = II(a, b, c, d, temp[0], MD5_S41, 0xf4292244);
            d = II(d, a, b, c, temp[7], MD5_S42, 0x432aff97);
            c = II(c, d, a, b, temp[14], MD5_S43, 0xab9423a7);
            b = II(b, c, d, a, temp[5], MD5_S44, 0xfc93a039);
            a = II(a, b, c, d, temp[12], MD5_S41, 0x655b59c3);
            d = II(d, a, b, c, temp[3], MD5_S42, 0x8f0ccc92);
            c = II(c, d, a, b, temp[10], MD5_S43, 0xffeff47d);
            b = II(b, c, d, a, temp[1], MD5_S44, 0x85845dd1);
            a = II(a, b, c, d, temp[8], MD5_S41, 0x6fa87e4f);
            d = II(d, a, b, c, temp[15], MD5_S42, 0xfe2ce6e0);
            c = II(c, d, a, b, temp[6], MD5_S43, 0xa3014314);
            b = II(b, c, d, a, temp[13], MD5_S44, 0x4e0811a1);
            a = II(a, b, c, d, temp[4], MD5_S41, 0xf7537e82);
            d = II(d, a, b, c, temp[11], MD5_S42, 0xbd3af235);
            c = II(c, d, a, b, temp[2], MD5_S43, 0x2ad7d2bb);
            b = II(b, c, d, a, temp[9], MD5_S44, 0xeb86d391);
